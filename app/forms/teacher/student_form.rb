class Teacher::StudentForm
  ...
  def initialize(student_member = nil)
    ...
    @student_member.build_home_address unless @student_member.build_home_address
    @student_member.build_parents_address unless @student_member.build_parents_address
  end
end